...
function CalculateCartPrice(value1,value2,...num1) { // ...num1(rest operator ) to pass multiple values by taking them in an array
    return num1;
}
...
function HandleObject(AnyObject) {
    console.log(`username is ${AnyObject.UserName} and price is ${AnyObject.price}`); // typechecking is important here if we write prices instead it will give undefined  
}
HandleObject(user)
HandleObject({
    UserName : "bruhman",
