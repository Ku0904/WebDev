...
console.log(document); // The entire webpage in the browser's memory, as a JavaScript object
// we can use all these inside DOM to manupilate page
//  Editing the local DOM of a webpage does not affect the document stored on the webserver
